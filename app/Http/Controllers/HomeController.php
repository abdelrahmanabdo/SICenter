...
class HomeController extends Controller
{
    ...
    {
        $y1_last_lesson = Lesson::whereClassYear(1)->orderBy('id' , 'desc')->first();
        $y2_last_lesson = Lesson::whereClassYear(2)->orderBy('id' , 'desc')->first();
        $y3_last_lesson = Lesson::whereClassYear(3)->orderBy('id' , 'desc')->first();
